...
public class MongoOrg implements Serializable {
  ...
  public boolean equals(Object obj) {
    ...
    } else return tenantId.equals(other.tenantId);
  }
  ...
  public static class Builder {
    ...
    public MongoOrg build() {
      if (StringUtils.isBlank(_mongoOrg.tenantId) || StringUtils.isBlank(_mongoOrg.apiKey) || StringUtils.isBlank(_mongoOrg.apiSecret) || _mongoOrg.org == null)
